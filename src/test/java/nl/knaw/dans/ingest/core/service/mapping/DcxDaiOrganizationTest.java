...
class DcxDaiOrganizationTest extends BaseTest {
    ...
    @Test
    void testToContributorValueObject() throws Exception {
    ...
    @Test
    void testToContributorValueObjectGivesOtherAsType() throws Exception {
        var doc = readDocumentFromString("<dcx-dai:organization xmlns:dcx-dai=\"http://easy.dans.knaw.nl/schemas/dcx/dai/\">\n"
    ...
    @Test
    void testToAuthorValueObjectUsesOrganizationNameAsAuthorName() throws Exception {
        var doc = readDocumentFromString("<dcx-dai:organization xmlns:dcx-dai=\"http://easy.dans.knaw.nl/schemas/dcx/dai/\">\n"
            + "    <dcx-dai:name xml:lang=\"en\">Anti-Vampire League</dcx-dai:name>\n"
            + "</dcx-dai:organization>\n");
    ...
    @Test
    void testToAuthorValueObjectUsesISNIIfPresent() throws Exception {
        var doc = readDocumentFromString("<dcx-dai:organization xmlns:dcx-dai=\"http://easy.dans.knaw.nl/schemas/dcx/dai/\">\n"
            + "    <dcx-dai:name xml:lang=\"en\">Anti-Vampire League</dcx-dai:name>\n"
    ...
    @Test
    void testToGrantNumberValueShouldCreateAGrantNumberWithOnlyAnOrganizationSubfield() throws Exception {
        var doc = readDocumentFromString("<dcx-dai:organization xmlns:dcx-dai=\"http://easy.dans.knaw.nl/schemas/dcx/dai/\">\n"
            + "    <dcx-dai:name xml:lang=\"en\">Anti-Vampire League</dcx-dai:name>\n"
