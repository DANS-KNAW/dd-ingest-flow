...
class AmdTest extends BaseTest {
    ...
    @Test
    void testGetFirstChangeToState() throws Exception {
        var str =
    ...
    @Test()
    void testUseDateOfFirstChangToPublishedStateIfNoChangeToSubmittedStateIsFound() throws Exception {
    ...
    @Test
    void testUseDateLastStateChangeIfNoStateChangeDatesAreAvailable() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
    ...
    @Test
    void testUseDateLastStateChangeIfNoNonBlankStateChangeDatesAreAvailable() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
    ...
    @Test
    void testUseDateLastStateChangeIfNoStateChangeDatesElementIsPresent() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
    ...
    @Test
    void toPublicationDateShouldUSeDateOfFirstChangeToPublishedState() throws Exception {
        var xml =
            "    <damd:administrative-md version=\"0.1\" xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:foxml=\"info:fedora/fedora-system:def/foxml#\">\n"
                + "      <datasetState>PUBLISHED</datasetState>\n"
                + "      <previousState>MAINTENANCE</previousState>\n"
    ...
    @Test
    void useDateLastStateChangeIfNoStateChangeDatesAreAvailable() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
    ...
    @Test
    void useDateLastStateChangeIfNoNonBlankStateChangeDatesAreAvailable() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
    ...
    @Test
    void useDateLastStateChangeIfNoStateChangeDatesElementIsPresent() throws Exception {
        var xml = "<damd:administrative-md xmlns:damd=\"http://easy.dans.knaw.nl/easy/dataset-administrative-metadata/\" version=\"0.1\">\n"
            + "                <datasetState>PUBLISHED</datasetState>\n"
            + "                <previousState>DRAFT</previousState>\n"
            + "                <lastStateChange>2019-04-25T12:20:01.636+02:00</lastStateChange>\n"
